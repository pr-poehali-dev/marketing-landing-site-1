      ...
      <section className="pt-32 pb-20 px-4 bg-gradient-to-b from-white via-blue-50/40 to-white">
        <div className="container mx-auto max-w-4xl">
          ...
          <p className="text-xl text-muted-foreground leading-relaxed mb-12 max-w-3xl">
            Один перформанс-канал, два таргетолога на входе, чёткая задача на масштаб. За 4 месяца нашёл рабочую связку, перестроил команду и вывел выручку на уровень 10+ млн рублей в месяц — при ДРР 25–27%.
          </p>
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-4">
            {[
              ...
              { num: '3', title: 'Тайминг и формат напоминаний', desc: 'Тестировал время отправки напоминаний о записанном уроке, формат сообщений, количество касаний. Нашёл оптимальное окно — доходимость на пробный урок выросла.' },
              { num: '4', title: 'Сокращение шагов до записи', desc: 'Убрал промежуточные шаги, которые не давали ценности пользователю. Меньше шагов — меньше трения — выше конверсия на каждом переходе.' },
            ].map((step) => (
