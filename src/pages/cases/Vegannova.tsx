  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-20 px-4 bg-gradient-to-b from-white via-green-50/40 to-white">
        <div className="container mx-auto max-w-4xl">
          ...
          <p className="text-lg md:text-xl text-muted-foreground mb-10 leading-relaxed max-w-3xl">
            90 артикулов, портфель БАДов и суперфудов, продажи на Wildberries и запуск собственного интернет-магазина с нуля. Выстроил аналитическую систему по каждому SKU и подгруппе товаров, нашёл точки роста в карточках и рекламе, запустил D2C-канал и Telegram-воронки — 14% покупателей возвращаются за повторной покупкой.
          </p>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="container mx-auto max-w-4xl">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">С чего начал</h2>
          <div className="prose prose-lg max-w-none text-muted-foreground mb-10 space-y-4">
            ...
            <p>Второй вызов: бренд хотел выйти за пределы маркетплейса — мне предстояло выстроить прямой канал продаж и наладить работу с покупателями напрямую.</p>
          </div>

          <div className="grid md:grid-cols-3 gap-4">
            {[
              { color: 'border-l-red-500 bg-red-50', icon: '🔴', title: 'Нет сегментации портфеля', desc: '90 артикулов управлялись как единая категория — я не видел разбивки по подгруппам и логикам спроса' },
              { color: 'border-l-red-500 bg-red-50', icon: '🔴', title: 'Нет системы планирования', desc: 'Не было алгоритма планирования продаж, декомпозиции в трафик и бюджет — мне предстояло выстроить это с нуля' },
              { color: 'border-l-yellow-500 bg-yellow-50', icon: '🟡', title: 'Нет D2C-канала', desc: 'Все продажи через Wildberries — я не мог контактировать с покупателем напрямую и работать с повторными покупками' },
            ].map((card, i) => (
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="rounded-2xl border-2 border-green-200 bg-green-50 p-7">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">Маркетплейс как основной драйвер выручки. Я выстроил аналитику по каждому SKU и подгруппе, нашёл и устранил потери в воронке — и вырос в обороте без пропорционального роста рекламных расходов.</p>
            </div>
            <div className="rounded-2xl border-2 border-blue-200 bg-blue-50 p-7">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">Запустил собственный канал продаж как инструмент лояльности и повторных покупок. Выстроил Telegram-воронки как мост между WB-покупателем и прямым каналом — чтобы снизить зависимость бренда от маркетплейса в долгосрочной перспективе.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-7 mb-6">
            ...
            <p className="text-sm text-muted-foreground mb-4">Я считал экономику одновременно в четырёх разрезах:</p>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">Это позволило мне видеть где именно теряются деньги — не «в категории БАД вообще», а конкретно в подгруппе «Коллаген» в карточке с артикулом Х.</p>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-7 mb-6">
            ...
            <p className="text-sm text-muted-foreground mb-6">Я строил план сверху вниз — от планового оборота до рекламного бюджета:</p>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed mt-6">Это дало мне чёткий ответ: сколько нужно показов и какой бюджет, чтобы выполнить план по выручке в каждой подгруппе. Планирование перестало быть интуицией — стало математикой.</p>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-7 mb-6">
            ...
            <p className="text-sm text-muted-foreground mb-6">Я внедрил отчёт «рука на пульсе» с автоматической подсветкой отклонений — два состояния, никакой двусмысленности:</p>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed mb-6">Каждый менеджер видел свою зону ответственности в реальном времени. Я и руководство видели общую картину по всем подгруппам. Время реакции на проблему сократилось с недель до дней.</p>

            <div className="space-y-4">
              <div className="rounded-xl overflow-hidden border border-gray-200">
                <img
                  src="https://cdn.poehali.dev/files/ff3b1eb0-3f53-494d-a9ed-d068e08d6fe7.png"
                  alt="РНП-таблица: отчёт продажи ВБ с цветовой подсветкой по подкатегориям"
                  className="w-full object-cover"
                />
                <div className="px-4 py-2 bg-gray-50 border-t border-gray-200">
                  <span className="text-xs text-muted-foreground">РНП — срез по подкатегориям: показы, корзины, клики, ДРР, конверсии</span>
                </div>
              </div>
              <div className="rounded-xl overflow-hidden border border-gray-200">
                <img
                  src="https://cdn.poehali.dev/files/83cfd321-5835-45b5-a239-4a8c2fed62c0.png"
                  alt="РНП-таблица: план/факт по менеджерам с отклонениями"
                  className="w-full object-cover"
                />
                <div className="px-4 py-2 bg-gray-50 border-t border-gray-200">
                  <span className="text-xs text-muted-foreground">РНП — план/факт по менеджерам с автоподсветкой отклонений</span>
                </div>
              </div>
            </div>
          </div>
              ...
              {[
                {
                  ...
                  desc: 'Использовал сервисы аналитики и подписку «Джем»: смотрел позиции конкурентов, ценовые стратегии, ставки в рекламе, визуал карточек, конверсии, объём продаж. По каждой подгруппе — делал отдельный срез рынка и формировал выводы для гипотез.',
                  icon: 'Search',
                },
                {
                  num: '02',
                  title: 'A/B-тесты главного фото',
                  desc: 'Тестировал ракурсы, раскладки, айдентику. Замерял изменение CTR после каждого теста. Победившие варианты масштабировал на похожие SKU внутри подгруппы.',
                  icon: 'ImageIcon',
                },
                {
                  num: '03',
                ...
                },
                {
                  ...
                  desc: 'Стратегически управлял вариантами и модификациями внутри категорий — для оптимизации позиций и конверсий.',
                  icon: 'Link2',
                },
                {
                  num: '05',
                  title: 'Контроль ДРР по SKU',
                  desc: 'Держал строгий контроль рекламных расходов на уровне каждого артикула и подгруппы.',
                  icon: 'TrendingDown',
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="container mx-auto max-w-4xl">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">Как я выстроил прямой канал с покупателями</h2>
          <p className="text-muted-foreground mb-8 leading-relaxed">Wildberries не даёт прямого контакта с покупателем. Я это изменил — через физическую точку входа прямо в упаковке каждого товара.</p>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white rounded-2xl border border-gray-200 p-7">
              ...
              <ul className="space-y-3">
                {[
                  'Провёл сравнительный анализ CMS-платформ → выбрал InSales как оптимальное решение под задачи бренда',
                  'Подключил платёжные модули и логистику',
                  'Интегрировал с CRM, email-маркетингом и Telegram-ботами',
                  'Настроил сегментированные цепочки: новые / повторные / брошенная корзина / пост-покупка',
                ].map((item, i) => (
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-7">
              ...
              <ul className="space-y-3">
                {[
                  'Провёл SEO-оптимизацию: структура каталога, метаданные, технический аудит, контент-карты категорий',
                  'Запустил регулярные акции и кэшбэк-механики для стимулирования прямых покупок',
                  'Настроил контекстную и таргетированную рекламу синхронизированную с Telegram-воронками',
                  'Собрал единую аналитику: D2C-магазин и Wildberries в одном дашборде',
                ].map((item, i) => (
                  <li key={i} className="flex items-start gap-3 text-sm text-muted-foreground">
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="rounded-xl overflow-hidden border border-gray-200 bg-white">
            <table className="w-full">
              ...
              <tbody>
                {[
                  { day: 'Понедельник', action: 'Разбираю РНП: зелёное масштабирую, розовое разбираю и исправляю' },
                  { day: 'Понедельник', action: 'Синхронизируюсь с менеджерами по товарным группам' },
                  { day: 'В течение недели', action: 'Запускаю гипотезы из фабрики: визуалы, ставки, склейка' },
                  { day: 'Пятница', action: 'Собираю результаты тестов, принимаю решения по бюджету на следующую неделю' },
                ].map((row, i) => (
                  <tr key={i} className="border-b border-gray-100 last:border-0">
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="p-6 bg-gray-50 rounded-xl border border-gray-200">
            <p className="text-gray-700 leading-relaxed">
              Рост оборота на 40% при росте рекламных расходов всего на 9% — это результат не «больше рекламы», а умной аналитики. Я сегментировал портфель по подгруппам, выстроил планирование с полной декомпозицией воронки, внедрил РНП с двухцветной подсветкой и запустил фабрику гипотез по карточкам — всё это вместе дало эффект который невозможно получить точечными правками.
            </p>
          </div>
        </div>
      </section>
            ...
            {[
              {
                ...
                desc: 'Я разбил портфель на подгруппы (Омега-3, Коллаген, Д3, Магний) — это дало точность управления которую невозможно получить при работе с «категорией БАД вообще». Каждая подгруппа получила свою экономику, свои гипотезы, свои решения.',
              },
              {
                icon: '💡',
                title: 'Планирование сверху вниз',
                desc: 'Алгоритм декомпозиции который я выстроил снял вопрос «а сколько нам тратить на рекламу?» — ответ всегда был в таблице, обоснованный цифрами воронки.',
              },
              {
                icon: '💡',
                title: 'РНП: два цвета — одно правило',
                desc: 'Зелёный — масштабирую. Розовый — немедленно разбираю и исправляю. Простая система без полутонов сократила время реакции на отклонения с недель до дней.',
              },
              {
                icon: '💡',
                title: 'Фабрика гипотез по карточкам',
                desc: 'Я тестировал визуалы и контент системно — не «поменяем фото и посмотрим», а структурированный цикл с замером CTR и конверсий после каждого теста.',
              },
              {
                icon: '💡',
                title: 'Telegram как канал удержания',
                desc: '14% повторных покупок через Telegram-воронки которые я запустил — это выручка без рекламных расходов на повторное привлечение. Каждый покупатель с Wildberries стал активом бренда, а не разовой транзакцией.',
              },
            ].map((card, i) => (
      ...
      <section id="contact" className="py-16 px-4 bg-gradient-to-b from-gray-50 to-white">
        <div className="container mx-auto max-w-4xl">
          ...
          <p className="text-muted-foreground leading-relaxed mb-12 max-w-3xl">
            За 10 месяцев я выстроил два параллельных контура роста. Wildberries: оборот +40% при рекламных расходах +9%, ДРР 8–11% — за счёт аналитики по подгруппам, планирования с декомпозицией и CRO карточек. D2C: запустил интернет-магазин на InSales, 8 Telegram-воронок, 500+ покупателей в базе за первый месяц, 14% повторных покупок. Система продолжает работать.
          </p>
