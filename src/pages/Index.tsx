        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center mb-12">
            <div className="flex flex-col items-center gap-4 shrink-0">
              ...
              <p className="font-semibold text-lg text-gray-900">Константин Пожидаев</p>
              <div className="flex gap-3">
                <a
                  href="https://t.me/ctr_agent"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 py-2 px-4 rounded-lg font-medium text-sm text-white transition-opacity hover:opacity-90"
                ...
                >
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="12" cy="12" r="12" fill="url(#maxGrad2)"/>
                    <defs>
                      <linearGradient id="maxGrad2" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse">
